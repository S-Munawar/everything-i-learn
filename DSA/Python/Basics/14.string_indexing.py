...
my_str[0]             # Index Access - O(1)

my_str[0:5]           # Slicing - O(K) where K is the size of the slice
my_str[::-1]          # Reversing string - O(N) where N is string length

# Concatenation
"a" + "b"             # Concatenation - O(N + M) where N and M are string lengths
