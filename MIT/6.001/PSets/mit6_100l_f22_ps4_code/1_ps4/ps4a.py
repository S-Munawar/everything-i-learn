...
def is_heap(tree, compare_func):
    ...
    '''
    # TODO: Removeh pass and write your code here
    if tree is None:
        return True
    left_child = tree.get_left_child()
    right_child = tree.get_right_child()
    if left_child is not None and not compare_func(left_child.get_value(), tree.get_value()):
        return False
    if right_child is not None and not compare_func(right_child.get_value(), tree.get_value()):
        return False
