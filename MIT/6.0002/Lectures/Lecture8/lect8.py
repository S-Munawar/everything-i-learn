...
# to get variance of population we add all the squared distances divided by no.of variables, so for variance of mean distribution, should not we add all the squared distance(means) from mean of  sample means divided by no.of samples?